var Library={
    ...
    render(){
        ...
        if (isArtistsTab) {
            ...
            html += '<div class="flex flex-col sm:flex-row gap-2.5 mb-5">' +
                '<button onclick="Library.createNew()" class="flex-1 bg-white/15 hover:bg-white/20 border border-white/20 font-bold py-3.5 rounded-2xl active:scale-95 flex items-center justify-center gap-2 text-white shadow-lg transition-all"><i data-lucide="plus" class="w-4 h-4"></i><span>Buat Playlist Baru</span></button>' +
                '<button onclick="SpotifyImport.open()" class="flex-1 bg-white/15 hover:bg-white/20 border border-white/20 font-bold py-3.5 rounded-2xl active:scale-95 flex items-center justify-center gap-2 text-white shadow-lg transition-all"><i data-lucide="music-2" class="w-4 h-4"></i><span>Import Spotify</span></button>' +
            '</div>';
